...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-04 12:41`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/eff4f18b-783e-42bd-80ec-777dfaa796a4.git
$ cd eff4f18b-783e-42bd-80ec-777dfaa796a4
```
